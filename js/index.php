...
<div class="main">
	<div class="placeholder_introduction" >
		...
		<p>
			...
			<p>
			If you work in the spectroscopy of a diatomic molecule not included in the database, please, register on the website and upload the data. The existing database can only grow and hence more helpful thanks to your contribution. Your contribution will lead to a proper citation of your work and make it visible to any other using visiting the website. 
			</p>
			<p>
			<p style="font-weight: bold">More data is more information, and more information may bring new questions to science.</p>
			</p>
