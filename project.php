...
<div class="main">
	<div class="placeholder_introduction" >
		<div style="font-size: 18px; font-family:'Times New Roman', Times, serif;">
			...
			<br>
			The project has been developed under the open-access philosophy promoted by the Max Planck Society.  Finally, we would like to emphasise that having more data only helps to understand better the underlying quantum mechanical nature behind the scene of molecules. 		
		</div>
	</div>
</div>
